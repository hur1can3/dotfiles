...
# -*- coding: utf-8 -*-
###############################################################################
# conkyclementine.py is a simple python script to gather 
# details of from Clementine for use in conky.
#
#  Author: Kaivalagi
# Created: 01/08/2010
    ...
    def getOutputData(self, datatype, ratingchar, statustext, nounknownoutput, maxlength):
        ...
        try:
            ...
            if self.musicData == None:
                ...
                if self.testDBus(bus, 'org.mpris.clementine'):
...
def main():
    ...
    if options.version == True:
        print >> sys.stdout,"conkyClementine v.2.00"
    else:
