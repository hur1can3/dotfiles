...
#    16/03/2009    Updated sunrise/sunset and daylight datatype extraction to cope better with datetime conversions
#    07/04/2009    Updated error handling for website/caching issues
#    18/05/2009    Updated to expand ~ based template paths
#    11/09/2009    Added WI (Weather Icon Path), MI (Moon Icon Path) and BI (Bearing Icon Path) datatype options, to be used in conjunction with the new conky $image operator
...
def main():
    ...
    if options.version == True:
        ...
        print >> sys.stdout,"conkyForecast v.2.09"
